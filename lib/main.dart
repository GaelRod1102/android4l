...
class MiAgendaFotograficaApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return new MaterialApp(title: "No tiene efecto", debugShowCheckedModeBanner: false, home: new PaginaPrincipal(title: "GridView Galeria de fotos Gael")); //Fin de materialApp
  } //Fin de widget
